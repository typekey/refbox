#!/usr/bin/env bash
# Build an RBrowser SQLite search index for every species/assembly that has an
# annotation file, writing {Species}/{Assembly}/build/annotation.rbrowser.sqlite.
#
...
for raw in "$RESULTS"/*/*/raw; do
  ...
  out="$asmdir/build/annotation.rbrowser.sqlite"
