/**
 * RBrowser Index (.rba) static search — frontend reference implementation.
 *
 * Mirrors refbox.sqlite_index.search() (refbox v0.5.5) exactly, against a
 * read-only *.rba (SQLite+FTS5) served as a static file and queried with sql.js-httpvfs
...
const DB_URL =
  "https://data.rbrowser.org/datahub/reference/hg38.gencode.v45.transcript.rba";
